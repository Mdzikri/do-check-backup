...
export const factData: IFact[] = [
  ...
  },
  {
    ...
    author: "Kata Data-",
    quotes:
      "The positive impact of a supportive work environment correlates between support for mental health at work, stress levels, and employee axiety. Therefore, it is important for companies to support the mental health of their employees (Gen Z & Millenials)",
