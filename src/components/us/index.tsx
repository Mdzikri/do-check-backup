    ...
    <div className="mt-10 mb-10">
      <div className="flex items-center justify-center">
        <div className="w-100 w-2/4 mb-10">
          <h4 className="text-center font-bold md:text-[32px] lg:text-[35px] md:leading-[45px]">
            Kalau kamu ngerasain salah satu bahkan semua hal di atas,
          </h4>
        </div>
      </div>

      <div className="flex md:w-5/6 lg:w-2/4 m-auto p-5">
        ...
        <div className="description-wrapper relative">
          <div className="absolute md:w-[400px] md:-left-[70px]">
            <h4 className="md:leading-[50px] mb-5 md:text-[37px] lg:text-[42px]">
