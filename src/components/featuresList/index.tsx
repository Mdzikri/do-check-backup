...
const FeatureList: React.FC<FeatureListProps> = ({ text, isActive }) => {
  return (
    <div
      className={`${
        isActive ? "text-inherit" : "text-[#b2b2b2]"
      } my-2 md:my-5 text-[14px] md:text-[16px] flex`}
    >
      <span className="mr-1">
        <svg
          width="24"
