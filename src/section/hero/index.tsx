        ...
        <div className="relative isolate px-6 pt-3 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div className="text-center">
              <h1 className="text-4xl 2xl:text-5xl font-bold tracking-tight text-gray-900 sm:text-6xl">{intl.formatMessage({ id: "greeting" })}</h1>
              <p className="mt-6 text-lg 2xl:text-2xl leading-8 text-gray-600">{intl.formatMessage({ id: "potential" })}</p>
